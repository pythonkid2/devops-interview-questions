...
[Home](../README.md) > [Companies](./README.md) > **Hexaware Technologies**
...
- [General](../topics/general.md) — 20
- [Databases](../topics/databases.md) — 2
- [API Gateway](../topics/api-gateway.md) — 1
...
- [API Gateway and Gateway Patterns](../topics/api-gateway.md#api-gateway-and-gateway-patterns) — Medium

### Azure

- [Azure Function Deployment](../topics/azure.md#azure-function-deployment) — Medium

### Databases

- [Horizontal Scaling and Sharding in MongoDB](../topics/databases.md#horizontal-scaling-and-sharding-in-mongodb) — Medium
- [MongoDB vs SQL Server](../topics/databases.md#mongodb-vs-sql-server) — Medium

### Docker

- [Docker and Containers](../topics/docker.md#docker-and-containers) — Medium

### General

- [Abstract Class – When to use](../topics/general.md#abstract-class-when-to-use) — Medium
- [Angular HTTP Interceptor to send Bearer Token with every request](../topics/general.md#angular-http-interceptor-to-send-bearer-token-with-every-request) — Medium
- [Benefits of Microservices](../topics/general.md#benefits-of-microservices) — Medium
- [Bulkhead Isolation Pattern (Polly)](../topics/general.md#bulkhead-isolation-pattern-polly) — Medium
- [Circuit Breaker Pattern](../topics/general.md#circuit-breaker-pattern) — Medium
- [Clustered vs Non-Clustered Index](../topics/general.md#clustered-vs-non-clustered-index) — Medium
- [Dependency Injection in .NET Core (Controller → Service → Repository → Program.cs registration)](../topics/general.md#dependency-injection-in-net-core-controller-service-repository-program-cs-regist) — Medium
- [Exponential Backoff](../topics/general.md#exponential-backoff) — Medium
- [gRPC and Protocol Buffers](../topics/general.md#grpc-and-protocol-buffers) — Medium
- [Handling Performance Issues after Production Release](../topics/general.md#handling-performance-issues-after-production-release) — Hard
- [Message Brokers used in projects and implementation](../topics/general.md#message-brokers-used-in-projects-and-implementation) — Medium
- [Microservices](../topics/general.md#microservices) — Medium
- [Monolithic vs Microservices](../topics/general.md#monolithic-vs-microservices) — Medium
- [Pseudocode for Retry Mechanism](../topics/general.md#pseudocode-for-retry-mechanism) — Medium
- [Rate Limiting](../topics/general.md#rate-limiting) — Medium
- [Real-time use cases of Interfaces](../topics/general.md#real-time-use-cases-of-interfaces) — Medium
- [Salary Calculation using OOP principles and SOLID concepts](../topics/general.md#salary-calculation-using-oop-principles-and-solid-concepts) — Medium
- [Single Sign-On (SSO) and its implementation](../topics/general.md#single-sign-on-sso-and-its-implementation) — Medium
- [Steps to migrate from Monolithic to Microservices](../topics/general.md#steps-to-migrate-from-monolithic-to-microservices) — Medium
- [Stored Procedure Performance Optimization](../topics/general.md#stored-procedure-performance-optimization) — Medium
