...
[Home](../README.md) > [Companies](./README.md) > **TCS**
...
- [A few AWS services and their use cases.](../topics/aws.md#a-few-aws-services-and-their-use-cases) — Medium
...
- [tree traversal](../topics/general.md#tree-traversal) — Medium
...
- [Kubernetes architecture and overall cluster structure.](../topics/kubernetes.md#kubernetes-architecture-and-overall-cluster-structure) — Hard · tags: `System Design`
- [Pod-to-Pod communication in Kubernetes.](../topics/kubernetes.md#pod-to-pod-communication-in-kubernetes) — Medium
