# How would you troubleshoot an HTTPS Application Load Balancer that isn't serving traffic as expected?

[Home](../../README.md) > [Topics](../../topics/README.md) > [AWS](../../topics/aws.md) > **Question**

| | |
| --- | --- |
| **Difficulty** | [Hard](../../browse/by-difficulty/hard.md) |
| **Topic** | [AWS](../../topics/aws.md) |
| **Asked** | 1× |
...
[← How would you manage different security policies for multipl](./how-would-you-manage-different-security-policies-for-multiple-aws-accounts.md) | [If a legitimate request receives a 403 Access Denied error d →](./if-a-legitimate-request-receives-a-403-access-denied-error-due-to-aws-waf-how-wo.md)
