# If a legitimate request receives a 403 Access Denied error due to AWS WAF, how would you troubleshoot it?
...
[← How would you troubleshoot an HTTPS Application Load Balance](./how-would-you-troubleshoot-an-https-application-load-balancer-that-isn-t-serving.md) | [Usage of AWS CodePipeline and AWS infrastructure in CI/CD. →](./usage-of-aws-codepipeline-and-aws-infrastructure-in-ci-cd.md)
