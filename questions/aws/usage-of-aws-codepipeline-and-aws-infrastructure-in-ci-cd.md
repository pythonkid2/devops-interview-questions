# Usage of AWS CodePipeline and AWS infrastructure in CI/CD.
...
[← If a legitimate request receives a 403 Access Denied error d](./if-a-legitimate-request-receives-a-403-access-denied-error-due-to-aws-waf-how-wo.md) | [What are AWS Regions and Availability Zones? →](./what-are-aws-regions-and-availability-zones.md)
