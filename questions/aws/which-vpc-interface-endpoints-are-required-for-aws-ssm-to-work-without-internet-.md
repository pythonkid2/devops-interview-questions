# Which VPC Interface Endpoints are required for AWS SSM to work without internet access?
...
[← Which AWS pricing model should you choose for different work](./which-aws-pricing-model-should-you-choose-for-different-workloads.md) | [Why did you choose a particular EC2 instance type (such as R →](./why-did-you-choose-a-particular-ec2-instance-type-such-as-r5-or-m5-for-your-work.md)
