# In a well-designed CI/CD pipeline for a critical banking application, is it acceptable to push code directly to production without automated testing if the developer is confident and time is limited?

[Home](../../README.md) > [Topics](../../topics/README.md) > [CI/CD](../../topics/ci-cd.md) > **Question**

| | |
| --- | --- |
| **Difficulty** | [Medium](../../browse/by-difficulty/medium.md) |
| **Topic** | [CI/CD](../../topics/ci-cd.md) |
| **Asked** | 1× |
| **Round** | First Round |
...
[← How would you optimize a pipeline that takes 25 minutes to c](./how-would-you-optimize-a-pipeline-that-takes-25-minutes-to-complete.md) | [List all the CI/CD solutions you have worked on and the reas →](./list-all-the-ci-cd-solutions-you-have-worked-on-and-the-reasons-for-having-more-.md)
