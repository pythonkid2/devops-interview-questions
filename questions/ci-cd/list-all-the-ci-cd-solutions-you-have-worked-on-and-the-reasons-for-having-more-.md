# List all the CI/CD solutions you have worked on and the reasons for having more than one approach.
...
[← In a well-designed CI/CD pipeline for a critical banking app](./in-a-well-designed-ci-cd-pipeline-for-a-critical-banking-application-is-it-accep.md) | [Suppose Jenkins currently handles Development, DevOps, and S →](./suppose-jenkins-currently-handles-development-devops-and-security-pipelines-how-.md)
