# A Docker container is consuming high CPU and memory. How would you check and troubleshoot it?
...
_Start of topic_ | [A Docker container works locally but fails in production. Wh →](./a-docker-container-works-locally-but-fails-in-production-why.md)
