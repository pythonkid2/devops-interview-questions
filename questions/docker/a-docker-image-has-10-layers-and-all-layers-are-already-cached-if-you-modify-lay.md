# A Docker image has 10 layers, and all layers are already cached. If you modify Layer 5 and rebuild the image, what will happen? Will Docker reuse the cache for Layers 6–10, or will those layers be rebuilt? Explain why.

[Home](../../README.md) > [Topics](../../topics/README.md) > [Docker](../../topics/docker.md) > **Question**
...
[← A Docker container works locally but fails in production. Wh](./a-docker-container-works-locally-but-fails-in-production-why.md) | [Can you explain the concept of Docker and how do you use it  →](./can-you-explain-the-concept-of-docker-and-how-do-you-use-it-in-your-projects.md)
