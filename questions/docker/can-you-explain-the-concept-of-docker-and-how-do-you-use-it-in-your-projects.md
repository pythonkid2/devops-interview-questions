# Can you explain the concept of Docker and how do you use it in your projects?
...
[← A Docker image has 10 layers, and all layers are already cac](./a-docker-image-has-10-layers-and-all-layers-are-already-cached-if-you-modify-lay.md) | [Difference between add and copy →](./difference-between-add-and-copy.md)
