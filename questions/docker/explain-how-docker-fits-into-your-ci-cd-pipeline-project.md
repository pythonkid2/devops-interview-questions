# Explain how Docker fits into your CI/CD pipeline project.
...
[← Explain Bridge, Host, and Overlay networks.](./explain-bridge-host-and-overlay-networks.md) | [Explain the Docker architecture. →](./explain-the-docker-architecture.md)
