# How does Docker's containerization work?
...
[← How does Docker help with environment consistency?](./how-does-docker-help-with-environment-consistency.md) | [If Docker images are built in Jenkins but security scanning  →](./if-docker-images-are-built-in-jenkins-but-security-scanning-must-happen-in-githu.md)
