# What best practices do you follow while writing a production-ready Dockerfile?
...
[← What are the benefits of containerization in Microservices a](./what-are-the-benefits-of-containerization-in-microservices-architecture.md) | [What happens internally when you run docker run? →](./what-happens-internally-when-you-run-docker-run.md)
