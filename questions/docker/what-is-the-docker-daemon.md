...
[← What happens internally when you run docker run?](./what-happens-internally-when-you-run-docker-run.md) | [What is the purpose of a Docker image? →](./what-is-the-purpose-of-a-docker-image.md)
