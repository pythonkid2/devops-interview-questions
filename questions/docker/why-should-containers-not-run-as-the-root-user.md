...
[← What problem does Docker solve?](./what-problem-does-docker-solve.md) | [Why use COPY app.jar app.jar instead of COPY . .? →](./why-use-copy-app-jar-app-jar-instead-of-copy.md)
