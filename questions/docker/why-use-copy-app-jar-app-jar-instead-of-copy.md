# Why use COPY app.jar app.jar instead of COPY . .?
...
[← Why should containers not run as the root user?](./why-should-containers-not-run-as-the-root-user.md) | [Write a simple Dockerfile and explain each instruction. →](./write-a-simple-dockerfile-and-explain-each-instruction.md)
