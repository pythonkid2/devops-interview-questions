# Write a simple Dockerfile and explain each instruction.
...
[← Why use COPY app.jar app.jar instead of COPY . .?](./why-use-copy-app-jar-app-jar-instead-of-copy.md) | [Your container is running, but the application is not access →](./your-container-is-running-but-the-application-is-not-accessible-how-would-you-tr.md)
