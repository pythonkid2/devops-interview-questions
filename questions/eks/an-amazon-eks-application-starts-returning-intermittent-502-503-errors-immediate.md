# An Amazon EKS application starts returning intermittent 502/503 errors immediately after deployment. How would you identify whether the issue is related to Kubernetes, the Load Balancer, or the application?

[Home](../../README.md) > [Topics](../../topics/README.md) > [EKS](../../topics/eks.md) > **Question**
...
_Start of topic_ | [During a node group upgrade, several workloads become unavai →](./during-a-node-group-upgrade-several-workloads-become-unavailable-even-though-rep.md)
