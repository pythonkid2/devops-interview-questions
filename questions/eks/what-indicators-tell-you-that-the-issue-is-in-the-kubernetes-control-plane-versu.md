# What indicators tell you that the issue is in the Kubernetes control plane versus the underlying AWS infrastructure?
...
[← During a node group upgrade, several workloads become unavai](./during-a-node-group-upgrade-several-workloads-become-unavailable-even-though-rep.md) | _End of topic_
