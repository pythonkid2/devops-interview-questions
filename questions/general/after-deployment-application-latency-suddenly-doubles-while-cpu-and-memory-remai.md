# After deployment, application latency suddenly doubles while CPU and memory remain normal. How would you approach the investigation?
...
[← A cloud-based e-commerce application experiences unpredictab](./a-cloud-based-e-commerce-application-experiences-unpredictable-traffic-spikes-ho.md) | [Can adhering strictly to the Single Responsibility Principle →](./can-adhering-strictly-to-the-single-responsibility-principle-in-large-distribute.md)
