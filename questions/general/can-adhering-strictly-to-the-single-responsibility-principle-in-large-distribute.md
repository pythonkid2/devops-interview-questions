# Can adhering strictly to the Single Responsibility Principle in large distributed systems increase overall system complexity and make maintenance more difficult?

[Home](../../README.md) > [Topics](../../topics/README.md) > [General](../../topics/general.md) > **Question**
...
[← After deployment, application latency suddenly doubles while](./after-deployment-application-latency-suddenly-doubles-while-cpu-and-memory-remai.md) | [Can you describe two production challenges you've faced and  →](./can-you-describe-two-production-challenges-you-ve-faced-and-how-you-resolved-the.md)
