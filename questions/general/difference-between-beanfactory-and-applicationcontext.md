...
[← Design the architecture of a mission-critical platform that ](./design-the-architecture-of-a-mission-critical-platform-that-must-scale-rapidly-a.md) | [Difference between Minor GC and Major GC. →](./difference-between-minor-gc-and-major-gc.md)
