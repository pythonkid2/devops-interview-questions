...
[← Design the architecture of a mission-critical platform that ](./design-the-architecture-of-a-mission-critical-platform-that-must-scale-rapidly-a.md) | [Difference between IAM Roles and IAM Policies. →](./difference-between-iam-roles-and-iam-policies.md)
