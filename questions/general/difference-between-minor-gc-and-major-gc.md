...
[← Difference between IAM Roles and IAM Policies.](./difference-between-iam-roles-and-iam-policies.md) | [Explain @Transactional annotation. →](./explain-transactional-annotation.md)
