...
[← Explain Saga Pattern with a real-world example.](./explain-saga-pattern-with-a-real-world-example.md) | [Explain the email and enterprise involvement/escalation flow →](./explain-the-email-and-enterprise-involvement-escalation-flow-followed-during-a-p.md)
