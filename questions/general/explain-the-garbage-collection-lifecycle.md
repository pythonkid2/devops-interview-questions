...
[← Explain the email and enterprise involvement/escalation flow](./explain-the-email-and-enterprise-involvement-escalation-flow-followed-during-a-p.md) | [Explain VPC, Subnets, NAT Gateway, and Internet Gateway. →](./explain-vpc-subnets-nat-gateway-and-internet-gateway.md)
