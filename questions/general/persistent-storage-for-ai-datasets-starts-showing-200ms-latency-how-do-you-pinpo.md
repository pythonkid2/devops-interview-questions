# Persistent storage for AI datasets starts showing 200ms+ latency. How do you pinpoint whether it’s the storage backend, the network, or the GPU node?
...
[← Most questions quickly evolved into production scenarios, tr](./most-questions-quickly-evolved-into-production-scenarios-troubleshooting-discuss.md) | [Production is down. Users are impacted. What will you do? →](./production-is-down-users-are-impacted-what-will-you-do.md)
