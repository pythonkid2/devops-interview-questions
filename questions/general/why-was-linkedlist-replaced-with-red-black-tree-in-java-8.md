...
[← Why should SELECT * be avoided in production queries?](./why-should-select-be-avoided-in-production-queries.md) | [Write an email to a client explaining the issue faced and th →](./write-an-email-to-a-client-explaining-the-issue-faced-and-the-solution-provided.md)
