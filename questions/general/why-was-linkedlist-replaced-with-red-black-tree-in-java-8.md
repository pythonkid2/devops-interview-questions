# Why was LinkedList replaced with Red-Black Tree in Java 8?
...
[← Why should SELECT * be avoided in production queries?](./why-should-select-be-avoided-in-production-queries.md) | [Will you be able to set up the Playwright framework from scr →](./will-you-be-able-to-set-up-the-playwright-framework-from-scratch-with-ai-capabil.md)
