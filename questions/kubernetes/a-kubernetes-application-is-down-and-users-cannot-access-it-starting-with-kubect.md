# A Kubernetes application is down, and users cannot access it. Starting with kubectl, explain your step-by-step troubleshooting approach until the issue is identified.
...
_Start of topic_ | [A Kubernetes GPU pod requests 16GB VRAM but only gets 12GB d →](./a-kubernetes-gpu-pod-requests-16gb-vram-but-only-gets-12gb-due-to-fragmentation-.md)
