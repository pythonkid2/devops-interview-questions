# Explain PersistentVolume (PV) and PersistentVolumeClaim (PVC).
...
[← Explain Kubernetes RBAC and how it controls access to cluste](./explain-kubernetes-rbac-and-how-it-controls-access-to-cluster-resources.md) | [Explain the complete request flow from a browser to a Kubern →](./explain-the-complete-request-flow-from-a-browser-to-a-kubernetes-pod.md)
