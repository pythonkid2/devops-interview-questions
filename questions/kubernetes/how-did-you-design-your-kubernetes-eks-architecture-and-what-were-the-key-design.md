# How did you design your Kubernetes (EKS) architecture, and what were the key design decisions?
...
[← Explain the end-to-end request flow in Kubernetes?](./explain-the-end-to-end-request-flow-in-kubernetes.md) | [How do multiple applications share a single Load Balancer an →](./how-do-multiple-applications-share-a-single-load-balancer-and-domain-name-in-kub.md)
