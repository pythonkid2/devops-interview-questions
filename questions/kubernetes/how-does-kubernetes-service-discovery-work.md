...
[← How do you use hpa in prod env and what kind of metric targe](./how-do-you-use-hpa-in-prod-env-and-what-kind-of-metric-target-in-cluster.md) | [How will you set up the Rest Assured framework when APIs are →](./how-will-you-set-up-the-rest-assured-framework-when-apis-are-internal-to-kuberne.md)
