# How will you set up the Rest Assured framework when APIs are internal to Kubernetes clusters?
...
[← How does Kubernetes Service Discovery work?](./how-does-kubernetes-service-discovery-work.md) | [How would you check if a GPU pod in Kubernetes is using the  →](./how-would-you-check-if-a-gpu-pod-in-kubernetes-is-using-the-gpu-assigned-to-it.md)
