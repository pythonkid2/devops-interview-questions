# How would you check if a GPU pod in Kubernetes is using the GPU assigned to it?
...
[← How will you set up the Rest Assured framework when APIs are](./how-will-you-set-up-the-rest-assured-framework-when-apis-are-internal-to-kuberne.md) | [How would you determine whether production failures originat →](./how-would-you-determine-whether-production-failures-originate-from-kubernetes-ne.md)
