# How would you determine whether production failures originate from Kubernetes, networking, or the application itself?
...
[← How would you check if a GPU pod in Kubernetes is using the ](./how-would-you-check-if-a-gpu-pod-in-kubernetes-is-using-the-gpu-assigned-to-it.md) | [How would you handle CUDA driver upgrades in Kubernetes with →](./how-would-you-handle-cuda-driver-upgrades-in-kubernetes-without-disrupting-thous.md)
