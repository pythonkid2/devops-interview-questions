# How would you handle CUDA driver upgrades in Kubernetes without disrupting thousands of running AI pods?
...
[← How would you determine whether production failures originat](./how-would-you-determine-whether-production-failures-originate-from-kubernetes-ne.md) | [Kubernetes pods are Running but users receive 503 errors. Wh →](./kubernetes-pods-are-running-but-users-receive-503-errors-what-will-you-check.md)
