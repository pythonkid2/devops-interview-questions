# What metrics and logs did you monitor after deployment?
...
[← What is the difference between a pod and a service in Kubern](./what-is-the-difference-between-a-pod-and-a-service-in-kubernetes.md) | [Which commands do you use for application deployment in Kube →](./which-commands-do-you-use-for-application-deployment-in-kubernetes.md)
