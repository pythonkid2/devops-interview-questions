# A tool installed on a Linux server is running slowly. How would you troubleshoot and improve its performance?
...
_Start of topic_ | [For a memory or CPU-related issue, what would be shown in lo →](./for-a-memory-or-cpu-related-issue-what-would-be-shown-in-logs-or-events.md)
