# For a memory or CPU-related issue, what would be shown in logs or events?

[Home](../../README.md) > [Topics](../../topics/README.md) > [Linux](../../topics/linux.md) > **Question**
...
- [What is systemd?](./what-is-systemd.md)
...
[← A tool installed on a Linux server is running slowly. How wo](./a-tool-installed-on-a-linux-server-is-running-slowly-how-would-you-troubleshoot-.md) | [How would you debug high CPU, memory, or disk utilization on →](./how-would-you-debug-high-cpu-memory-or-disk-utilization-on-a-linux-server.md)

[Topic: Linux](../../topics/linux.md) · [All questions](../README.md) · [Home](../../README.md)
