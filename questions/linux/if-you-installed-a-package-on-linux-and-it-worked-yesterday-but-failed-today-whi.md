# If you installed a package on Linux and it worked yesterday but failed today, which logs would you check?
...
[← How would you debug high CPU, memory, or disk utilization on](./how-would-you-debug-high-cpu-memory-or-disk-utilization-on-a-linux-server.md) | [What is systemd? →](./what-is-systemd.md)
