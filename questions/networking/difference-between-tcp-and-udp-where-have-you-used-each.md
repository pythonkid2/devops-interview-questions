# Difference between TCP and UDP. Where have you used each?
...
[← An application works perfectly in one Availability Zone but ](./an-application-works-perfectly-in-one-availability-zone-but-intermittently-fails.md) | [Explain Load Balancer, Reverse Proxy, and Ingress with real  →](./explain-load-balancer-reverse-proxy-and-ingress-with-real-examples.md)
