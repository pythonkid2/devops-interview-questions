# Explain Load Balancer, Reverse Proxy, and Ingress with real examples.
...
[← Difference between TCP and UDP. Where have you used each?](./difference-between-tcp-and-udp-where-have-you-used-each.md) | [Explain VPC, Subnets, NAT Gateway, and Internet Gateway. →](./explain-vpc-subnets-nat-gateway-and-internet-gateway.md)
