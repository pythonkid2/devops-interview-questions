# What is the difference between a load balancer and an application firewall?
...
[← How would you design a VPC architecture that supports multip](./how-would-you-design-a-vpc-architecture-that-supports-multiple-application-teams.md) | [Your application is reachable internally but inaccessible fr →](./your-application-is-reachable-internally-but-inaccessible-from-the-internet-afte.md)
