# What is the purpose of a service mesh, and how does it relate to microservices architecture?

[Home](../../README.md) > [Topics](../../topics/README.md) > [Service Mesh|Microservices](../../topics/service-mesh-microservices.md) > **Question**

| | |
| --- | --- |
| **Difficulty** | [Medium](../../browse/by-difficulty/medium.md) |
| **Topic** | [Service Mesh|Microservices](../../topics/service-mesh-microservices.md) |
| **Asked** | 2× |
...
`Medium` `Service Mesh|Microservices`
...
[Topic: Service Mesh|Microservices](../../topics/service-mesh-microservices.md) · [All questions](../README.md) · [Home](../../README.md)
