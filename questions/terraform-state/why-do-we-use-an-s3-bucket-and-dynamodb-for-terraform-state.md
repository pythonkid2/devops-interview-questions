# Why do we use an S3 bucket and DynamoDB for Terraform state?

[Home](../../README.md) > [Topics](../../topics/README.md) > [Terraform State](../../topics/terraform-state.md) > **Question**

| | |
| --- | --- |
| **Difficulty** | [Medium](../../browse/by-difficulty/medium.md) |
| **Topic** | [Terraform State](../../topics/terraform-state.md) |
| **Asked** | 1× |
| **Round** | First Round |
...
[Topic: Terraform State](../../topics/terraform-state.md) · [All questions](../README.md) · [Home](../../README.md)
