# How did you deploy components like HPA, Karpenter, Metrics Server, and CoreDNS? Did you use Terraform?
...
[← Have you worked on Terraform recently, and which version(s)?](./have-you-worked-on-terraform-recently-and-which-version-s.md) | [How do you import an existing AWS resource into Terraform? →](./how-do-you-import-an-existing-aws-resource-into-terraform.md)
