...
[← How does Terraform state locking work?](./how-does-terraform-state-locking-work.md) | [How would you design Terraform code to manage a large number →](./how-would-you-design-terraform-code-to-manage-a-large-number-of-similar-resource.md)
