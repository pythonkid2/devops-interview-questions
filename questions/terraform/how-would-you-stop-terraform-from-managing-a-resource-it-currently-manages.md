# How would you stop Terraform from managing a resource it currently manages?
...
[← How would you rate your Terraform proficiency on a scale of ](./how-would-you-rate-your-terraform-proficiency-on-a-scale-of-1-5.md) | [If the Terraform State File is lost, how can it be recovered →](./if-the-terraform-state-file-is-lost-how-can-it-be-recovered.md)
