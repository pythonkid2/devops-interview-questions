# Is there a safer alternative to directly modifying the Terraform state file in a production environment?
...
[← If the Terraform State File is lost, how can it be recovered](./if-the-terraform-state-file-is-lost-how-can-it-be-recovered.md) | [Terraform changes accidentally modify production resources.  →](./terraform-changes-accidentally-modify-production-resources-how-would-you-recover.md)
