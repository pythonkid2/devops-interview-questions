# Terraform changes accidentally modify production resources. How would you recover?
...
[← Is there a safer alternative to directly modifying the Terra](./is-there-a-safer-alternative-to-directly-modifying-the-terraform-state-file-in-a.md) | [Terraform project architecture →](./terraform-project-architecture.md)
