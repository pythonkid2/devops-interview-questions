...
[← What is a Terraform State File, and why is it important?](./what-is-a-terraform-state-file-and-why-is-it-important.md) | [What is statefile explain more about it and where to store a →](./what-is-statefile-explain-more-about-it-and-where-to-store-and-why-if-lost-if-do.md)
