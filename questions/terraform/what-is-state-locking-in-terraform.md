...
[← What is remote state?](./what-is-remote-state.md) | [What is statefile explain more about it and where to store a →](./what-is-statefile-explain-more-about-it-and-where-to-store-and-why-if-lost-if-do.md)
