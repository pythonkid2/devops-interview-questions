# Which IaC tool have you used for provisioning infrastructure?
...
[← What is the purpose of Terraform in infrastructure as code?](./what-is-the-purpose-of-terraform-in-infrastructure-as-code.md) | [Which meta-arguments have you used in Terraform (e.g., count →](./which-meta-arguments-have-you-used-in-terraform-e-g-count-for-each-depends-on-li.md)
