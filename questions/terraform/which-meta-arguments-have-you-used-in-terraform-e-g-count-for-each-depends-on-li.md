# Which meta-arguments have you used in Terraform (e.g., count, for_each, depends_on, lifecycle)?
...
[← Which IaC tool have you used for provisioning infrastructure](./which-iac-tool-have-you-used-for-provisioning-infrastructure.md) | [Write Terraform code to provision an AWS EC2 instance. →](./write-terraform-code-to-provision-an-aws-ec2-instance.md)
