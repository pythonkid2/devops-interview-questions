# Write Terraform code to provision an AWS EC2 instance.
...
[← Why do we use Terraform?](./why-do-we-use-terraform.md) | [You accidentally deleted a resource from Terraform code but  →](./you-accidentally-deleted-a-resource-from-terraform-code-but-don-t-want-it-to-be-.md)
