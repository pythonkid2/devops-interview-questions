# You accidentally deleted a resource from Terraform code but don't want it to be destroyed. What will you do?
...
[← Write Terraform code to provision an AWS EC2 instance.](./write-terraform-code-to-provision-an-aws-ec2-instance.md) | [You need to deploy an EC2 instance and an S3 bucket, and out →](./you-need-to-deploy-an-ec2-instance-and-an-s3-bucket-and-output-the-instance-publ.md)
