# You need to deploy an EC2 instance and an S3 bucket, and output the instance public IP and bucket name. How will you do it?
...
[← You accidentally deleted a resource from Terraform code but ](./you-accidentally-deleted-a-resource-from-terraform-code-but-don-t-want-it-to-be-.md) | [You need to provision 100 EC2 instances with different confi →](./you-need-to-provision-100-ec2-instances-with-different-configurations-across-dev.md)
