# You need to provision a VPC with 3 public subnets and 2 private subnets across 2 AZs. How will you do it using Terraform?
...
[← You need to provision 100 EC2 instances with different confi](./you-need-to-provision-100-ec2-instances-with-different-configurations-across-dev.md) | [You need to update an AMI ID of an EC2 instance without down →](./you-need-to-update-an-ami-id-of-an-ec2-instance-without-downtime-how-will-you-ac.md)
