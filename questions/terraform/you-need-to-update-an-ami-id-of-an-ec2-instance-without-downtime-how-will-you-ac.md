# You need to update an AMI ID of an EC2 instance without downtime. How will you achieve this?
...
[← You need to provision a VPC with 3 public subnets and 2 priv](./you-need-to-provision-a-vpc-with-3-public-subnets-and-2-private-subnets-across-2.md) | [Your team is working on the same Terraform code. How will yo →](./your-team-is-working-on-the-same-terraform-code-how-will-you-handle-the-state-fi.md)
