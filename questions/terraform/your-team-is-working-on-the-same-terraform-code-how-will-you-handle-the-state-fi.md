# Your team is working on the same Terraform code. How will you handle the state file?
...
[← You need to update an AMI ID of an EC2 instance without down](./you-need-to-update-an-ami-id-of-an-ec2-instance-without-downtime-how-will-you-ac.md) | [Your Terraform apply is failing due to a resource already ex →](./your-terraform-apply-is-failing-due-to-a-resource-already-exists-error-how-will-.md)
