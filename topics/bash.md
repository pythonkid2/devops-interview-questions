...
- [Explain your CPU monitoring script line by line.](../topics/bash.md#explain-your-cpu-monitoring-script-line-by-line) — **2×** · Medium
  <a id="explain-your-cpu-monitoring-script-line-by-line"></a>
- [How would you schedule the cleanup script every week?](../topics/bash.md#how-would-you-schedule-the-cleanup-script-every-week) — **2×** · Medium
  <a id="how-would-you-schedule-the-cleanup-script-every-week"></a>
- [What automation tasks have you done using Shell scripting?](../topics/bash.md#what-automation-tasks-have-you-done-using-shell-scripting) — **2×** · Medium
  <a id="what-automation-tasks-have-you-done-using-shell-scripting"></a>
- [What is the meaning of -mtime +7?](../topics/bash.md#what-is-the-meaning-of-mtime-7) — **2×** · Medium
...
- [What repetitive tasks have you automated using Bash/Shell scripting?](../topics/bash.md#what-repetitive-tasks-have-you-automated-using-bash-shell-scripting) — **2×** · Medium
  <a id="what-repetitive-tasks-have-you-automated-using-bash-shell-scripting"></a>
...
- [Write a Shell script to monitor CPU utilization.](../topics/bash.md#write-a-shell-script-to-monitor-cpu-utilization) — **2×** · Medium
  <a id="write-a-shell-script-to-monitor-cpu-utilization"></a>
- [Write PowerShell scripts for monitoring and troubleshooting Azure resources.](../topics/bash.md#write-powershell-scripts-for-monitoring-and-troubleshooting-azure-resources) — **1×** · Hard
...
- [Explain your CPU monitoring script line by line.](../topics/bash.md#explain-your-cpu-monitoring-script-line-by-line) — 2×
  <a id="explain-your-cpu-monitoring-script-line-by-line"></a>
- [How would you schedule the cleanup script every week?](../topics/bash.md#how-would-you-schedule-the-cleanup-script-every-week) — 2×
  <a id="how-would-you-schedule-the-cleanup-script-every-week"></a>
- [What automation tasks have you done using Shell scripting?](../topics/bash.md#what-automation-tasks-have-you-done-using-shell-scripting) — 2×
  <a id="what-automation-tasks-have-you-done-using-shell-scripting"></a>
- [What is the meaning of -mtime +7?](../topics/bash.md#what-is-the-meaning-of-mtime-7) — 2×
  <a id="what-is-the-meaning-of-mtime-7"></a>
- [What is the output of the following command? echo hi \|\| echo hello](../topics/bash.md#what-is-the-output-of-the-following-command-echo-hi-echo-hello) — 2×
  <a id="what-is-the-output-of-the-following-command-echo-hi-echo-hello"></a>
- [What repetitive tasks have you automated using Bash/Shell scripting?](../topics/bash.md#what-repetitive-tasks-have-you-automated-using-bash-shell-scripting) — 2×
  <a id="what-repetitive-tasks-have-you-automated-using-bash-shell-scripting"></a>
...
- [Write PowerShell scripts for monitoring and troubleshooting Azure resources.](../topics/bash.md#write-powershell-scripts-for-monitoring-and-troubleshooting-azure-resources) — 1×
  <a id="write-powershell-scripts-for-monitoring-and-troubleshooting-azure-resources"></a>
...
- [Explain your CPU monitoring script line by line.](../topics/bash.md#explain-your-cpu-monitoring-script-line-by-line)
- [How would you schedule the cleanup script every week?](../topics/bash.md#how-would-you-schedule-the-cleanup-script-every-week)
- [What automation tasks have you done using Shell scripting?](../topics/bash.md#what-automation-tasks-have-you-done-using-shell-scripting)
- [What is the meaning of -mtime +7?](../topics/bash.md#what-is-the-meaning-of-mtime-7)
- [What is the output of the following command? echo hi \|\| echo hello](../topics/bash.md#what-is-the-output-of-the-following-command-echo-hi-echo-hello)
- [Write a Shell script for weekly log cleanup.](../topics/bash.md#write-a-shell-script-for-weekly-log-cleanup)
- [Write a Shell script to monitor CPU utilization.](../topics/bash.md#write-a-shell-script-to-monitor-cpu-utilization)
...
- [What automation tasks have you done using Shell scripting?](../topics/bash.md#what-automation-tasks-have-you-done-using-shell-scripting) — 2026-07-15
...
| Question | Diff | Asked |
| --- | --- | ---: |
| [Explain your CPU monitoring script line by line.](../topics/bash.md#explain-your-cpu-monitoring-script-line-by-line) | Medium | 2 |
| [How would you schedule the cleanup script every week?](../topics/bash.md#how-would-you-schedule-the-cleanup-script-every-week) | Medium | 2 |
| [What automation tasks have you done using Shell scripting?](../topics/bash.md#what-automation-tasks-have-you-done-using-shell-scripting) | Medium | 2 |
...
| [What repetitive tasks have you automated using Bash/Shell scripting?](../topics/bash.md#what-repetitive-tasks-have-you-automated-using-bash-shell-scripting) | Medium | 2 |
