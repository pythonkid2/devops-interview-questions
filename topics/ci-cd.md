...
**87** real interview questions. Study this page end-to-end — open a detail page only when an answer is enriched.
...
| --- | ---: |
| Questions | 87 |
| Easy / Medium / Hard | 12 / 61 / 14 |
| Companies | 13 |

## Most asked

- [Your CI/CD pipeline takes 60 minutes. How would you reduce it to under 5 minutes?](../topics/ci-cd.md#your-ci-cd-pipeline-takes-60-minutes-how-would-you-reduce-it-to-under-5-minutes) — **10×** · Medium
...
- [What is the difference between Continuous Delivery and Continuous Deployment?](../topics/ci-cd.md#what-is-the-difference-between-continuous-delivery-and-continuous-deployment) — **6×** · Medium
  <a id="what-is-the-difference-between-continuous-delivery-and-continuous-deployment"></a>
- [CI/CD Pipeline Architecture](../topics/ci-cd.md#ci-cd-pipeline-architecture) — **5×** · Hard · tags: `System Design`
  <a id="ci-cd-pipeline-architecture"></a>
- [How do you troubleshoot a failed CI/CD pipeline?](../topics/ci-cd.md#how-do-you-troubleshoot-a-failed-ci-cd-pipeline) — **5×** · Medium
  <a id="how-do-you-troubleshoot-a-failed-ci-cd-pipeline"></a>
- [Explain your CI/CD pipeline from code commit to production.](../topics/ci-cd.md#explain-your-ci-cd-pipeline-from-code-commit-to-production) — **4×** · Medium
...
- [How do you manage secrets securely in CI/CD pipelines?](../topics/ci-cd.md#how-do-you-manage-secrets-securely-in-ci-cd-pipelines) — **4×** · Medium
...
- [Have you optimized CI/CD pipeline ? what problem you have faced ?](../topics/ci-cd.md#have-you-optimized-ci-cd-pipeline-what-problem-you-have-faced) — **3×** · Medium
...
- [What is the ideal pipeline would look in your mind ? explain strategies ?](../topics/ci-cd.md#what-is-the-ideal-pipeline-would-look-in-your-mind-explain-strategies) — **3×** · Easy
...
- [Can you explain CI/CD pipelines?](../topics/ci-cd.md#can-you-explain-ci-cd-pipelines) — **2×** · Medium
...
- [Explain your role in setting up the CI/CD pipeline and the tasks for which the DevOps team needs to be approached.](../topics/ci-cd.md#explain-your-role-in-setting-up-the-ci-cd-pipeline-and-the-tasks-for-which-the-d) — **2×** · Medium
...
- [How does a pipeline handle parallel jobs and dependencies?](../topics/ci-cd.md#how-does-a-pipeline-handle-parallel-jobs-and-dependencies) — **2×** · Medium
  <a id="how-does-a-pipeline-handle-parallel-jobs-and-dependencies"></a>

## Beginner

- [What is a CI/CD pipeline?](../topics/ci-cd.md#what-is-a-ci-cd-pipeline) — 4×
  <a id="what-is-a-ci-cd-pipeline"></a>
- [Complete End to End #DevOps CI/CD pipeline workflow](../topics/ci-cd.md#complete-end-to-end-devops-ci-cd-pipeline-workflow) — 3×
  <a id="complete-end-to-end-devops-ci-cd-pipeline-workflow"></a>
- [What is the ideal pipeline would look in your mind ? explain strategies ?](../topics/ci-cd.md#what-is-the-ideal-pipeline-would-look-in-your-mind-explain-strategies) — 3×
  <a id="what-is-the-ideal-pipeline-would-look-in-your-mind-explain-strategies"></a>
...
- [What are the different sections in declarative pipeline?](../topics/ci-cd.md#what-are-the-different-sections-in-declarative-pipeline) — 1×
...
- [What is the purpose of Azure DevOps?](../topics/ci-cd.md#what-is-the-purpose-of-azure-devops) — 1×
  <a id="what-is-the-purpose-of-azure-devops"></a>
- [What is your experience with CI/CD pipelines?](../topics/ci-cd.md#what-is-your-experience-with-ci-cd-pipelines) — 1×
  <a id="what-is-your-experience-with-ci-cd-pipelines"></a>
- [Write YAML templates for Azure DevOps Pipelines.](../topics/ci-cd.md#write-yaml-templates-for-azure-devops-pipelines) — 1×
  <a id="write-yaml-templates-for-azure-devops-pipelines"></a>

## Intermediate

- [Your CI/CD pipeline takes 60 minutes. How would you reduce it to under 5 minutes?](../topics/ci-cd.md#your-ci-cd-pipeline-takes-60-minutes-how-would-you-reduce-it-to-under-5-minutes) — 10×
  <a id="your-ci-cd-pipeline-takes-60-minutes-how-would-you-reduce-it-to-under-5-minutes"></a>
- [What is the difference between Continuous Delivery and Continuous Deployment?](../topics/ci-cd.md#what-is-the-difference-between-continuous-delivery-and-continuous-deployment) — 6×
  <a id="what-is-the-difference-between-continuous-delivery-and-continuous-deployment"></a>
- [How do you troubleshoot a failed CI/CD pipeline?](../topics/ci-cd.md#how-do-you-troubleshoot-a-failed-ci-cd-pipeline) — 5×
  <a id="how-do-you-troubleshoot-a-failed-ci-cd-pipeline"></a>
- [Explain your CI/CD pipeline from code commit to production.](../topics/ci-cd.md#explain-your-ci-cd-pipeline-from-code-commit-to-production) — 4×
  <a id="explain-your-ci-cd-pipeline-from-code-commit-to-production"></a>
- [How do you manage secrets securely in CI/CD pipelines?](../topics/ci-cd.md#how-do-you-manage-secrets-securely-in-ci-cd-pipelines) — 4×
  <a id="how-do-you-manage-secrets-securely-in-ci-cd-pipelines"></a>
- [What is Continuous Integration (CI)?](../topics/ci-cd.md#what-is-continuous-integration-ci) — 4×
  <a id="what-is-continuous-integration-ci"></a>
- [Have you optimized CI/CD pipeline ? what problem you have faced ?](../topics/ci-cd.md#have-you-optimized-ci-cd-pipeline-what-problem-you-have-faced) — 3×
  <a id="have-you-optimized-ci-cd-pipeline-what-problem-you-have-faced"></a>
- [Build fails even though the pipeline runs—what usually breaks?](../topics/ci-cd.md#build-fails-even-though-the-pipeline-runs-what-usually-breaks) — 2×
  <a id="build-fails-even-though-the-pipeline-runs-what-usually-breaks"></a>
- [Can you explain CI/CD pipelines?](../topics/ci-cd.md#can-you-explain-ci-cd-pipelines) — 2×
  <a id="can-you-explain-ci-cd-pipelines"></a>
...
- [Explain your role in setting up the CI/CD pipeline and the tasks for which the DevOps team needs to be approached.](../topics/ci-cd.md#explain-your-role-in-setting-up-the-ci-cd-pipeline-and-the-tasks-for-which-the-d) — 2×
  <a id="explain-your-role-in-setting-up-the-ci-cd-pipeline-and-the-tasks-for-which-the-d"></a>
- [How do you implement rollback if deployment fails?](../topics/ci-cd.md#how-do-you-implement-rollback-if-deployment-fails) — 2×
  <a id="how-do-you-implement-rollback-if-deployment-fails"></a>
- [How do you implement zero-downtime deployments?](../topics/ci-cd.md#how-do-you-implement-zero-downtime-deployments) — 2×
  <a id="how-do-you-implement-zero-downtime-deployments"></a>
- [How does a pipeline handle parallel jobs and dependencies?](../topics/ci-cd.md#how-does-a-pipeline-handle-parallel-jobs-and-dependencies) — 2×
  <a id="how-does-a-pipeline-handle-parallel-jobs-and-dependencies"></a>
...
- [Pipeline Failure Handling Strategies](../topics/ci-cd.md#pipeline-failure-handling-strategies) — 2×
  <a id="pipeline-failure-handling-strategies"></a>
- [What happens internally in a CI/CD pipeline from commit → deploy?](../topics/ci-cd.md#what-happens-internally-in-a-ci-cd-pipeline-from-commit-deploy) — 2×
...
- [What would you do if your pipeline suddenly takes 30 minutes instead of 5?](../topics/ci-cd.md#what-would-you-do-if-your-pipeline-suddenly-takes-30-minutes-instead-of-5) — 2×
  <a id="what-would-you-do-if-your-pipeline-suddenly-takes-30-minutes-instead-of-5"></a>
- [What's your approach to secrets management in a CI/CD pipeline?](../topics/ci-cd.md#what-s-your-approach-to-secrets-management-in-a-ci-cd-pipeline) — 2×
  <a id="what-s-your-approach-to-secrets-management-in-a-ci-cd-pipeline"></a>
- [Which CI/CD tool are you using?](../topics/ci-cd.md#which-ci-cd-tool-are-you-using) — 2×
  <a id="which-ci-cd-tool-are-you-using"></a>
...
- [Your deployment pipeline succeeds, but the application fails after deployment. What would be your next steps?](../topics/ci-cd.md#your-deployment-pipeline-succeeds-but-the-application-fails-after-deployment-wha) — 2×
...
- [A pipeline processing 100 million records is taking too long. How would you optimize it?](../topics/ci-cd.md#a-pipeline-processing-100-million-records-is-taking-too-long-how-would-you-optim) — 1×
  <a id="a-pipeline-processing-100-million-records-is-taking-too-long-how-would-you-optim"></a>
...
- [ADF pipeline failed at 2 AM. What would you check first?](../topics/ci-cd.md#adf-pipeline-failed-at-2-am-what-would-you-check-first) — 1×
  <a id="adf-pipeline-failed-at-2-am-what-would-you-check-first"></a>
- [AI-powered CI/CD](../topics/ci-cd.md#ai-powered-ci-cd) — 1×
  <a id="ai-powered-ci-cd"></a>
...
- [CI/CD, rollback and security best practices](../topics/ci-cd.md#ci-cd-rollback-and-security-best-practices) — 1×
...
- [Did you create CI/CD pipelines from scratch or work on existing pipelines?](../topics/ci-cd.md#did-you-create-ci-cd-pipelines-from-scratch-or-work-on-existing-pipelines) — 1×
  <a id="did-you-create-ci-cd-pipelines-from-scratch-or-work-on-existing-pipelines"></a>
- [Explain the CI/CD pipeline you created for CSV validation and S3 upload.](../topics/ci-cd.md#explain-the-ci-cd-pipeline-you-created-for-csv-validation-and-s3-upload) — 1× · tags: `AWS`
  <a id="explain-the-ci-cd-pipeline-you-created-for-csv-validation-and-s3-upload"></a>
- [Explain the stages of a CI/CD pipeline.](../topics/ci-cd.md#explain-the-stages-of-a-ci-cd-pipeline) — 1×
  <a id="explain-the-stages-of-a-ci-cd-pipeline"></a>
...
- [How do you ensure developers cannot merge code unless all mandatory pipeline stages are successful?](../topics/ci-cd.md#how-do-you-ensure-developers-cannot-merge-code-unless-all-mandatory-pipeline-sta) — 1×
  <a id="how-do-you-ensure-developers-cannot-merge-code-unless-all-mandatory-pipeline-sta"></a>
- [How do you handle the rollbacks in CICD ?](../topics/ci-cd.md#how-do-you-handle-the-rollbacks-in-cicd) — 1×
  <a id="how-do-you-handle-the-rollbacks-in-cicd"></a>
...
- [How do you manage Git, YAML Pipelines, ARM/Bicep (Good to Have) for infrastructure as code?](../topics/ci-cd.md#how-do-you-manage-git-yaml-pipelines-arm-bicep-good-to-have-for-infrastructure-a) — 1×
  <a id="how-do-you-manage-git-yaml-pipelines-arm-bicep-good-to-have-for-infrastructure-a"></a>
- [How do you set up a CICD pipeline for an AWS-hosted application?](../topics/ci-cd.md#how-do-you-set-up-a-cicd-pipeline-for-an-aws-hosted-application) — 1× · tags: `AWS`
  <a id="how-do-you-set-up-a-cicd-pipeline-for-an-aws-hosted-application"></a>
- [How have you used artifact repositories in your CI/CD pipelines?](../topics/ci-cd.md#how-have-you-used-artifact-repositories-in-your-ci-cd-pipelines) — 1×
...
- [If an L3 team created the pipeline, how do you understand and troubleshoot it?](../topics/ci-cd.md#if-an-l3-team-created-the-pipeline-how-do-you-understand-and-troubleshoot-it) — 1×
  <a id="if-an-l3-team-created-the-pipeline-how-do-you-understand-and-troubleshoot-it"></a>
...
- [Run a Hello World pipeline.](../topics/ci-cd.md#run-a-hello-world-pipeline) — 1×
  <a id="run-a-hello-world-pipeline"></a>
- [Sensitive customer data is being moved to ADLS. How would you secure the pipeline and credentials?](../topics/ci-cd.md#sensitive-customer-data-is-being-moved-to-adls-how-would-you-secure-the-pipeline) — 1×
  <a id="sensitive-customer-data-is-being-moved-to-adls-how-would-you-secure-the-pipeline"></a>
...
- [The pipeline succeeds, but the target has fewer records than the source. How would you identify and reconcile the missing records?](../topics/ci-cd.md#the-pipeline-succeeds-but-the-target-has-fewer-records-than-the-source-how-would) — 1×
  <a id="the-pipeline-succeeds-but-the-target-has-fewer-records-than-the-source-how-would"></a>
...
- [What CI/CD pipeline did you use to deploy your application?](../topics/ci-cd.md#what-ci-cd-pipeline-did-you-use-to-deploy-your-application) — 1×
  <a id="what-ci-cd-pipeline-did-you-use-to-deploy-your-application"></a>
...
- [What would you do if your data pipeline suddenly started producing incorrect results?](../topics/ci-cd.md#what-would-you-do-if-your-data-pipeline-suddenly-started-producing-incorrect-res) — 1×
  <a id="what-would-you-do-if-your-data-pipeline-suddenly-started-producing-incorrect-res"></a>
- [Your CI/CD deployment failed. The rollback pipeline also failed because it depends on the deployment stage. How would you redesign the pipeline to avoid this situation?](../topics/ci-cd.md#your-ci-cd-deployment-failed-the-rollback-pipeline-also-failed-because-it-depend) — 1×
  <a id="your-ci-cd-deployment-failed-the-rollback-pipeline-also-failed-because-it-depend"></a>
- [Your CI/CD platform executes 25,000 deployments per month, but deployment success has dropped from 99.5% to 91%. How would you identify and eliminate the root causes?](../topics/ci-cd.md#your-ci-cd-platform-executes-25000-deployments-per-month-but-deployment-success-) — 1×
  <a id="your-ci-cd-platform-executes-25000-deployments-per-month-but-deployment-success-"></a>
...
- [How would you implement multi-environment CI/CD while preventing configuration drift?](../topics/ci-cd.md#how-would-you-implement-multi-environment-ci-cd-while-preventing-configuration-d) — 7×
  <a id="how-would-you-implement-multi-environment-ci-cd-while-preventing-configuration-d"></a>
- [CI/CD Pipeline Architecture](../topics/ci-cd.md#ci-cd-pipeline-architecture) — 5× · tags: `System Design`
  <a id="ci-cd-pipeline-architecture"></a>
...
- [How do you design CI/CD pipelines for complex microservices or multi-repository environments?](../topics/ci-cd.md#how-do-you-design-ci-cd-pipelines-for-complex-microservices-or-multi-repository-) — 3×
  <a id="how-do-you-design-ci-cd-pipelines-for-complex-microservices-or-multi-repository-"></a>
- [CICD successfully completed but application failed in prod env so how do you troubleshoot and what could be the issue.](../topics/ci-cd.md#cicd-successfully-completed-but-application-failed-in-prod-env-so-how-do-you-tro) — 2×
  <a id="cicd-successfully-completed-but-application-failed-in-prod-env-so-how-do-you-tro"></a>
...
- [How do Jenkins, Docker, Kubernetes, Terraform, Prometheus, and Grafana work together in a complete CI/CD pipeline?](../topics/ci-cd.md#how-do-jenkins-docker-kubernetes-terraform-prometheus-and-grafana-work-together-) — 2×
  <a id="how-do-jenkins-docker-kubernetes-terraform-prometheus-and-grafana-work-together-"></a>
- [How would you design a CI/CD pipeline with an automatic rollback strategy?](../topics/ci-cd.md#how-would-you-design-a-ci-cd-pipeline-with-an-automatic-rollback-strategy) — 2×
...
- [Can you design an event-driven pipeline with a Pub/Sub system using GCP?](../topics/ci-cd.md#can-you-design-an-event-driven-pipeline-with-a-pub-sub-system-using-gcp) — 1× · tags: `GCP`
  <a id="can-you-design-an-event-driven-pipeline-with-a-pub-sub-system-using-gcp"></a>
- [CI/CD pipeline failures & production rollback](../topics/ci-cd.md#ci-cd-pipeline-failures-production-rollback) — 1×
...
- [Explain the complete CI/CD flow that you built end-to-end.](../topics/ci-cd.md#explain-the-complete-ci-cd-flow-that-you-built-end-to-end)
- [What was your role in the CI/CD pipeline?](../topics/ci-cd.md#what-was-your-role-in-the-ci-cd-pipeline)

### Managerial

- [Explain your role in setting up the CI/CD pipeline and the tasks for which the DevOps team needs to be approached.](../topics/ci-cd.md#explain-your-role-in-setting-up-the-ci-cd-pipeline-and-the-tasks-for-which-the-d)
- [List all the CI/CD solutions you have worked on and the reasons for having more than one approach.](../topics/ci-cd.md#list-all-the-ci-cd-solutions-you-have-worked-on-and-the-reasons-for-having-more-)

### Technical Round 1

- [How do Jenkins, Docker, Kubernetes, Terraform, Prometheus, and Grafana work together in a complete CI/CD pipeline?](../topics/ci-cd.md#how-do-jenkins-docker-kubernetes-terraform-prometheus-and-grafana-work-together-)
- [How have you used artifact repositories in your CI/CD pipelines?](../topics/ci-cd.md#how-have-you-used-artifact-repositories-in-your-ci-cd-pipelines)
- [How would you integrate vulnerability scanning tools such as Trivy or Snyk into GitHub Actions?](../topics/ci-cd.md#how-would-you-integrate-vulnerability-scanning-tools-such-as-trivy-or-snyk-into-)
- [In a well-designed CI/CD pipeline for a critical banking application, is it acceptable to push code directly to production without automated testing if the developer is confident and time is limited?](../topics/ci-cd.md#in-a-well-designed-ci-cd-pipeline-for-a-critical-banking-application-is-it-accep)
- [Suppose Jenkins currently handles Development, DevOps, and Security pipelines. How would you move security scanning stages from Jenkins to GitHub Actions?](../topics/ci-cd.md#suppose-jenkins-currently-handles-development-devops-and-security-pipelines-how-)
- [What is the difference between JFrog Artifactory and JFrog Xray?](../topics/ci-cd.md#what-is-the-difference-between-jfrog-artifactory-and-jfrog-xray)
...
- [A pipeline processing 100 million records is taking too long. How would you optimize it?](../topics/ci-cd.md#a-pipeline-processing-100-million-records-is-taking-too-long-how-would-you-optim)
...
- [ADF pipeline failed at 2 AM. What would you check first?](../topics/ci-cd.md#adf-pipeline-failed-at-2-am-what-would-you-check-first)
- [AI-powered CI/CD](../topics/ci-cd.md#ai-powered-ci-cd)
...
- [Can you design an event-driven pipeline with a Pub/Sub system using GCP?](../topics/ci-cd.md#can-you-design-an-event-driven-pipeline-with-a-pub-sub-system-using-gcp) — tags: `GCP`
...
- [CI/CD pipeline failures & production rollback](../topics/ci-cd.md#ci-cd-pipeline-failures-production-rollback)
- [CI/CD, rollback and security best practices](../topics/ci-cd.md#ci-cd-rollback-and-security-best-practices)
...
- [Did you create CI/CD pipelines from scratch or work on existing pipelines?](../topics/ci-cd.md#did-you-create-ci-cd-pipelines-from-scratch-or-work-on-existing-pipelines)
- [Explain the CI/CD pipeline you created for CSV validation and S3 upload.](../topics/ci-cd.md#explain-the-ci-cd-pipeline-you-created-for-csv-validation-and-s3-upload) — tags: `AWS`
...
- [Explain the stages of a CI/CD pipeline.](../topics/ci-cd.md#explain-the-stages-of-a-ci-cd-pipeline)
...
- [How do you handle the rollbacks in CICD ?](../topics/ci-cd.md#how-do-you-handle-the-rollbacks-in-cicd)
...
- [How do you manage Git, YAML Pipelines, ARM/Bicep (Good to Have) for infrastructure as code?](../topics/ci-cd.md#how-do-you-manage-git-yaml-pipelines-arm-bicep-good-to-have-for-infrastructure-a)
- [How do you manage secrets securely in CI/CD pipelines?](../topics/ci-cd.md#how-do-you-manage-secrets-securely-in-ci-cd-pipelines)
- [How do you set up a CICD pipeline for an AWS-hosted application?](../topics/ci-cd.md#how-do-you-set-up-a-cicd-pipeline-for-an-aws-hosted-application) — tags: `AWS`
...
- [If an L3 team created the pipeline, how do you understand and troubleshoot it?](../topics/ci-cd.md#if-an-l3-team-created-the-pipeline-how-do-you-understand-and-troubleshoot-it)
- [Migrate GitHub repositories to Azure DevOps.](../topics/ci-cd.md#migrate-github-repositories-to-azure-devops)
- [Pipeline Failure Handling Strategies](../topics/ci-cd.md#pipeline-failure-handling-strategies)
- [Run a Hello World pipeline.](../topics/ci-cd.md#run-a-hello-world-pipeline)
- [Sensitive customer data is being moved to ADLS. How would you secure the pipeline and credentials?](../topics/ci-cd.md#sensitive-customer-data-is-being-moved-to-adls-how-would-you-secure-the-pipeline)
- [The pipeline succeeds, but the target has fewer records than the source. How would you identify and reconcile the missing records?](../topics/ci-cd.md#the-pipeline-succeeds-but-the-target-has-fewer-records-than-the-source-how-would)
- [Understand the complete pipeline flow and what happens when a build fails.](../topics/ci-cd.md#understand-the-complete-pipeline-flow-and-what-happens-when-a-build-fails)
...
- [What CI/CD pipeline did you use to deploy your application?](../topics/ci-cd.md#what-ci-cd-pipeline-did-you-use-to-deploy-your-application)
...
- [What is the difference between Jenkins, GitHub Actions, and Bitbucket Pipelines?](../topics/ci-cd.md#what-is-the-difference-between-jenkins-github-actions-and-bitbucket-pipelines)
- [What is the ideal pipeline would look in your mind ? explain strategies ?](../topics/ci-cd.md#what-is-the-ideal-pipeline-would-look-in-your-mind-explain-strategies)
- [What is the purpose of Azure DevOps?](../topics/ci-cd.md#what-is-the-purpose-of-azure-devops)
- [What is your experience with CI/CD pipelines?](../topics/ci-cd.md#what-is-your-experience-with-ci-cd-pipelines)
- [What would you do if your data pipeline suddenly started producing incorrect results?](../topics/ci-cd.md#what-would-you-do-if-your-data-pipeline-suddenly-started-producing-incorrect-res)
- [What would you do if your pipeline suddenly takes 30 minutes instead of 5?](../topics/ci-cd.md#what-would-you-do-if-your-pipeline-suddenly-takes-30-minutes-instead-of-5)
- [What's your approach to secrets management in a CI/CD pipeline?](../topics/ci-cd.md#what-s-your-approach-to-secrets-management-in-a-ci-cd-pipeline)
- [When you perform a Git merge, what are the different options you use?](../topics/ci-cd.md#when-you-perform-a-git-merge-what-are-the-different-options-you-use)
- [Which CI/CD tool are you using?](../topics/ci-cd.md#which-ci-cd-tool-are-you-using)
- [Why does a Canvas App work perfectly in Dev but fail in Production, and how do you troubleshoot it?](../topics/ci-cd.md#why-does-a-canvas-app-work-perfectly-in-dev-but-fail-in-production-and-how-do-yo)
- [Write YAML templates for Azure DevOps Pipelines.](../topics/ci-cd.md#write-yaml-templates-for-azure-devops-pipelines)
- [Your CI/CD deployment breaks after a code merge. How do you identify the root cause?](../topics/ci-cd.md#your-ci-cd-deployment-breaks-after-a-code-merge-how-do-you-identify-the-root-cau)
- [Your CI/CD deployment failed. The rollback pipeline also failed because it depends on the deployment stage. How would you redesign the pipeline to avoid this situation?](../topics/ci-cd.md#your-ci-cd-deployment-failed-the-rollback-pipeline-also-failed-because-it-depend)
- [Your CI/CD pipeline takes 60 minutes. How would you reduce it to under 5 minutes?](../topics/ci-cd.md#your-ci-cd-pipeline-takes-60-minutes-how-would-you-reduce-it-to-under-5-minutes)
...
- [Pipeline Failure Handling Strategies](../topics/ci-cd.md#pipeline-failure-handling-strategies) — 2026-08-12
- [The pipeline succeeds, but the target has fewer records than the source. How would you identify and reconcile the missing records?](../topics/ci-cd.md#the-pipeline-succeeds-but-the-target-has-fewer-records-than-the-source-how-would) — 2026-08-12
- [Sensitive customer data is being moved to ADLS. How would you secure the pipeline and credentials?](../topics/ci-cd.md#sensitive-customer-data-is-being-moved-to-adls-how-would-you-secure-the-pipeline) — 2026-08-12
- [How would you implement multi-environment CI/CD while preventing configuration drift?](../topics/ci-cd.md#how-would-you-implement-multi-environment-ci-cd-while-preventing-configuration-d) — 2026-08-12
- [Your CI/CD pipeline takes 60 minutes. How would you reduce it to under 5 minutes?](../topics/ci-cd.md#your-ci-cd-pipeline-takes-60-minutes-how-would-you-reduce-it-to-under-5-minutes) — 2026-08-12
- [Can you explain CI/CD pipelines?](../topics/ci-cd.md#can-you-explain-ci-cd-pipelines) — 2026-08-12
...
- [How do you troubleshoot a failed CI/CD pipeline?](../topics/ci-cd.md#how-do-you-troubleshoot-a-failed-ci-cd-pipeline) — 2026-08-10
- [AI-powered CI/CD](../topics/ci-cd.md#ai-powered-ci-cd) — 2026-08-10
- [What CI/CD pipeline did you use to deploy your application?](../topics/ci-cd.md#what-ci-cd-pipeline-did-you-use-to-deploy-your-application) — 2026-08-10
- [Explain your CI/CD pipeline from code commit to production.](../topics/ci-cd.md#explain-your-ci-cd-pipeline-from-code-commit-to-production) — 2026-08-10
...
- [How does a pipeline handle parallel jobs and dependencies?](../topics/ci-cd.md#how-does-a-pipeline-handle-parallel-jobs-and-dependencies) — 2026-08-10
- [What happens internally in a CI/CD pipeline from commit → deploy?](../topics/ci-cd.md#what-happens-internally-in-a-ci-cd-pipeline-from-commit-deploy) — 2026-08-10
...
| [A pipeline processing 100 million records is taking too long. How would you optimize it?](../topics/ci-cd.md#a-pipeline-processing-100-million-records-is-taking-too-long-how-would-you-optim) | Medium | 1 |
...
| [ADF pipeline failed at 2 AM. What would you check first?](../topics/ci-cd.md#adf-pipeline-failed-at-2-am-what-would-you-check-first) | Medium | 1 |
| [AI-powered CI/CD](../topics/ci-cd.md#ai-powered-ci-cd) | Medium | 1 |
...
| [Can you design an event-driven pipeline with a Pub/Sub system using GCP?](../topics/ci-cd.md#can-you-design-an-event-driven-pipeline-with-a-pub-sub-system-using-gcp) | Hard | 1 |
| [Can you explain CI/CD pipelines?](../topics/ci-cd.md#can-you-explain-ci-cd-pipelines) | Medium | 2 |
...
| [CI/CD pipeline failures & production rollback](../topics/ci-cd.md#ci-cd-pipeline-failures-production-rollback) | Hard | 1 |
| [CI/CD, rollback and security best practices](../topics/ci-cd.md#ci-cd-rollback-and-security-best-practices) | Medium | 1 |
...
| [Did you create CI/CD pipelines from scratch or work on existing pipelines?](../topics/ci-cd.md#did-you-create-ci-cd-pipelines-from-scratch-or-work-on-existing-pipelines) | Medium | 1 |
| [Explain the CI/CD pipeline you created for CSV validation and S3 upload.](../topics/ci-cd.md#explain-the-ci-cd-pipeline-you-created-for-csv-validation-and-s3-upload) | Medium | 1 |
...
| [Explain your CI/CD pipeline from code commit to production.](../topics/ci-cd.md#explain-your-ci-cd-pipeline-from-code-commit-to-production) | Medium | 4 |
...
| [Have you optimized CI/CD pipeline ? what problem you have faced ?](../topics/ci-cd.md#have-you-optimized-ci-cd-pipeline-what-problem-you-have-faced) | Medium | 3 |
...
| [How do you design CI/CD pipelines for complex microservices or multi-repository environments?](../topics/ci-cd.md#how-do-you-design-ci-cd-pipelines-for-complex-microservices-or-multi-repository-) | Hard | 3 |
...
| [How do you handle the rollbacks in CICD ?](../topics/ci-cd.md#how-do-you-handle-the-rollbacks-in-cicd) | Medium | 1 |
...
| [How do you manage secrets securely in CI/CD pipelines?](../topics/ci-cd.md#how-do-you-manage-secrets-securely-in-ci-cd-pipelines) | Medium | 4 |
| [How do you set up a CICD pipeline for an AWS-hosted application?](../topics/ci-cd.md#how-do-you-set-up-a-cicd-pipeline-for-an-aws-hosted-application) | Medium | 1 |
| [How do you troubleshoot a failed CI/CD pipeline?](../topics/ci-cd.md#how-do-you-troubleshoot-a-failed-ci-cd-pipeline) | Medium | 5 |
| [How does a pipeline handle parallel jobs and dependencies?](../topics/ci-cd.md#how-does-a-pipeline-handle-parallel-jobs-and-dependencies) | Medium | 2 |
...
| [How would you design a CI/CD pipeline with an automatic rollback strategy?](../topics/ci-cd.md#how-would-you-design-a-ci-cd-pipeline-with-an-automatic-rollback-strategy) | Hard | 2 |
...
| [How would you implement multi-environment CI/CD while preventing configuration drift?](../topics/ci-cd.md#how-would-you-implement-multi-environment-ci-cd-while-preventing-configuration-d) | Hard | 7 |
...
| [If an L3 team created the pipeline, how do you understand and troubleshoot it?](../topics/ci-cd.md#if-an-l3-team-created-the-pipeline-how-do-you-understand-and-troubleshoot-it) | Medium | 1 |
...
| [Pipeline Failure Handling Strategies](../topics/ci-cd.md#pipeline-failure-handling-strategies) | Medium | 2 |
| [Run a Hello World pipeline.](../topics/ci-cd.md#run-a-hello-world-pipeline) | Medium | 1 |
| [Sensitive customer data is being moved to ADLS. How would you secure the pipeline and credentials?](../topics/ci-cd.md#sensitive-customer-data-is-being-moved-to-adls-how-would-you-secure-the-pipeline) | Medium | 1 |
...
| [The pipeline succeeds, but the target has fewer records than the source. How would you identify and reconcile the missing records?](../topics/ci-cd.md#the-pipeline-succeeds-but-the-target-has-fewer-records-than-the-source-how-would) | Medium | 1 |
...
| [What CI/CD pipeline did you use to deploy your application?](../topics/ci-cd.md#what-ci-cd-pipeline-did-you-use-to-deploy-your-application) | Medium | 1 |
...
| [What happens internally in a CI/CD pipeline from commit → deploy?](../topics/ci-cd.md#what-happens-internally-in-a-ci-cd-pipeline-from-commit-deploy) | Medium | 2 |
...
| [What is the difference between Continuous Delivery and Continuous Deployment?](../topics/ci-cd.md#what-is-the-difference-between-continuous-delivery-and-continuous-deployment) | Medium | 6 |
...
| [What is the ideal pipeline would look in your mind ? explain strategies ?](../topics/ci-cd.md#what-is-the-ideal-pipeline-would-look-in-your-mind-explain-strategies) | Easy | 3 |
| [What is the purpose of Azure DevOps?](../topics/ci-cd.md#what-is-the-purpose-of-azure-devops) | Easy | 1 |
| [What is your experience with CI/CD pipelines?](../topics/ci-cd.md#what-is-your-experience-with-ci-cd-pipelines) | Easy | 1 |
| [What was your role in the CI/CD pipeline?](../topics/ci-cd.md#what-was-your-role-in-the-ci-cd-pipeline) | Medium | 2 |
| [What would you do if your data pipeline suddenly started producing incorrect results?](../topics/ci-cd.md#what-would-you-do-if-your-data-pipeline-suddenly-started-producing-incorrect-res) | Medium | 1 |
| [What would you do if your pipeline suddenly takes 30 minutes instead of 5?](../topics/ci-cd.md#what-would-you-do-if-your-pipeline-suddenly-takes-30-minutes-instead-of-5) | Medium | 2 |
| [What's your approach to secrets management in a CI/CD pipeline?](../topics/ci-cd.md#what-s-your-approach-to-secrets-management-in-a-ci-cd-pipeline) | Medium | 2 |
| [When you perform a Git merge, what are the different options you use?](../topics/ci-cd.md#when-you-perform-a-git-merge-what-are-the-different-options-you-use) | Easy | 2 |
| [Which CI/CD tool are you using?](../topics/ci-cd.md#which-ci-cd-tool-are-you-using) | Medium | 2 |
...
| [Your CI/CD pipeline takes 60 minutes. How would you reduce it to under 5 minutes?](../topics/ci-cd.md#your-ci-cd-pipeline-takes-60-minutes-how-would-you-reduce-it-to-under-5-minutes) | Medium | 10 |
