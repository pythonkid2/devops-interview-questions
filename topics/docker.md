...
**105** real interview questions. Study this page end-to-end — open a detail page only when an answer is enriched.
...
| --- | ---: |
| Questions | 105 |
| Easy / Medium / Hard | 26 / 68 / 11 |
| Companies | 7 |

## Most asked

- [What happens internally when you run docker run?](../topics/docker.md#what-happens-internally-when-you-run-docker-run) — **6×** · Medium
  <a id="what-happens-internally-when-you-run-docker-run"></a>
- [What is the difference between a Docker Image and a Docker Container?](../topics/docker.md#what-is-the-difference-between-a-docker-image-and-a-docker-container) — **5×** · Easy
  <a id="what-is-the-difference-between-a-docker-image-and-a-docker-container"></a>
- [What is Docker?](../topics/docker.md#what-is-docker) — **3×** · Easy
...
- [Docker architectures](../topics/docker.md#docker-architectures) — **2×** · Hard
...
- [How do you check Docker container logs?](../topics/docker.md#how-do-you-check-docker-container-logs) — **2×** · Medium
  <a id="how-do-you-check-docker-container-logs"></a>
- [How do you inject environment variables during Docker builds and where do you store images?](../topics/docker.md#how-do-you-inject-environment-variables-during-docker-builds-and-where-do-you-st) — **2×** · Medium
  <a id="how-do-you-inject-environment-variables-during-docker-builds-and-where-do-you-st"></a>
- [How do you reduce the size of a Docker image?](../topics/docker.md#how-do-you-reduce-the-size-of-a-docker-image) — **2×** · Medium
  <a id="how-do-you-reduce-the-size-of-a-docker-image"></a>
- [How do you secure container images before deployment?](../topics/docker.md#how-do-you-secure-container-images-before-deployment) — **2×** · Medium
  <a id="how-do-you-secure-container-images-before-deployment"></a>
- [How do you use docker stats during troubleshooting?](../topics/docker.md#how-do-you-use-docker-stats-during-troubleshooting) — **2×** · Medium
...
- [What is the difference between a Docker Image and a Docker Container?](../topics/docker.md#what-is-the-difference-between-a-docker-image-and-a-docker-container) — 5×
  <a id="what-is-the-difference-between-a-docker-image-and-a-docker-container"></a>
- [What is Docker?](../topics/docker.md#what-is-docker) — 3×
  <a id="what-is-docker"></a>
...
- [What are the 3 types of Docker volumes?](../topics/docker.md#what-are-the-3-types-of-docker-volumes) — 2×
...
- [What is the purpose of depends_on in Docker Compose?](../topics/docker.md#what-is-the-purpose-of-depends-on-in-docker-compose) — 2×
...
- [What are Docker volumes and bind mounts?](../topics/docker.md#what-are-docker-volumes-and-bind-mounts) — 1×
  <a id="what-are-docker-volumes-and-bind-mounts"></a>
- [What are Docker Volumes, and why are they used?](../topics/docker.md#what-are-docker-volumes-and-why-are-they-used) — 1×
  <a id="what-are-docker-volumes-and-why-are-they-used"></a>
- [What are Dockerfile best practices?](../topics/docker.md#what-are-dockerfile-best-practices) — 1×
  <a id="what-are-dockerfile-best-practices"></a>
- [What are Multi-Stage Docker Builds and why are they important?](../topics/docker.md#what-are-multi-stage-docker-builds-and-why-are-they-important) — 1×
...
- [What is a multi-stage Docker build?](../topics/docker.md#what-is-a-multi-stage-docker-build) — 1×
  <a id="what-is-a-multi-stage-docker-build"></a>
- [What is Docker Compose?](../topics/docker.md#what-is-docker-compose) — 1×
...
- [What is the command to run a container](../topics/docker.md#what-is-the-command-to-run-a-container) — 1×
  <a id="what-is-the-command-to-run-a-container"></a>
...
- [A Docker image has 10 layers, and all layers are already cached. If you modify Layer 5 and rebuild the image, what will happen? Will Docker reuse the cache for Layers 6–10, or will those layers be rebuilt? Explain why.](../topics/docker.md#a-docker-image-has-10-layers-and-all-layers-are-already-cached-if-you-modify-lay) — 2×
  <a id="a-docker-image-has-10-layers-and-all-layers-are-already-cached-if-you-modify-lay"></a>
- [Container restarted and data got lost — how do you fix it?](../topics/docker.md#container-restarted-and-data-got-lost-how-do-you-fix-it) — 2×
  <a id="container-restarted-and-data-got-lost-how-do-you-fix-it"></a>
...
- [How do you reduce the size of a Docker image?](../topics/docker.md#how-do-you-reduce-the-size-of-a-docker-image) — 2×
  <a id="how-do-you-reduce-the-size-of-a-docker-image"></a>
- [How do you secure container images before deployment?](../topics/docker.md#how-do-you-secure-container-images-before-deployment) — 2×
  <a id="how-do-you-secure-container-images-before-deployment"></a>
- [How do you use docker stats during troubleshooting?](../topics/docker.md#how-do-you-use-docker-stats-during-troubleshooting) — 2×
  <a id="how-do-you-use-docker-stats-during-troubleshooting"></a>
...
- [Which container registry do you trust for your images?](../topics/docker.md#which-container-registry-do-you-trust-for-your-images) — 2×
  <a id="which-container-registry-do-you-trust-for-your-images"></a>
- [Write a simple Dockerfile and explain each instruction.](../topics/docker.md#write-a-simple-dockerfile-and-explain-each-instruction) — 2×
...
- [Can you explain how Docker works?](../topics/docker.md#can-you-explain-how-docker-works) — 1×
  <a id="can-you-explain-how-docker-works"></a>
...
- [Can you explain your experience with Docker?](../topics/docker.md#can-you-explain-your-experience-with-docker) — 1×
  <a id="can-you-explain-your-experience-with-docker"></a>
- [Can you write a command to add volume or bind mount in container](../topics/docker.md#can-you-write-a-command-to-add-volume-or-bind-mount-in-container) — 1×
  <a id="can-you-write-a-command-to-add-volume-or-bind-mount-in-container"></a>
...
- [Explain how Docker fits into your CI/CD pipeline project.](../topics/docker.md#explain-how-docker-fits-into-your-ci-cd-pipeline-project) — 1× · tags: `CI/CD`
...
- [How do you debug failed Docker containers?](../topics/docker.md#how-do-you-debug-failed-docker-containers) — 1×
  <a id="how-do-you-debug-failed-docker-containers"></a>
- [How do you deploy applications using Docker?](../topics/docker.md#how-do-you-deploy-applications-using-docker) — 1×
  <a id="how-do-you-deploy-applications-using-docker"></a>
- [How do you deploy multiple microservices using Docker Compose?](../topics/docker.md#how-do-you-deploy-multiple-microservices-using-docker-compose) — 1×
  <a id="how-do-you-deploy-multiple-microservices-using-docker-compose"></a>
- [How do you integrate Docker with CI/CD pipelines?](../topics/docker.md#how-do-you-integrate-docker-with-ci-cd-pipelines) — 1× · tags: `CI/CD`
  <a id="how-do-you-integrate-docker-with-ci-cd-pipelines"></a>
- [How do you manage environment-specific configuration in Docker?](../topics/docker.md#how-do-you-manage-environment-specific-configuration-in-docker) — 1×
  <a id="how-do-you-manage-environment-specific-configuration-in-docker"></a>
...
- [How would you use Docker to implement a Pub/Sub system?](../topics/docker.md#how-would-you-use-docker-to-implement-a-pub-sub-system) — 1×
  <a id="how-would-you-use-docker-to-implement-a-pub-sub-system"></a>
...
- [What is containerization, and how do you deploy a .NET application using Docker?](../topics/docker.md#what-is-containerization-and-how-do-you-deploy-a-net-application-using-docker) — 1×
  <a id="what-is-containerization-and-how-do-you-deploy-a-net-application-using-docker"></a>
...
- [Your Docker image builds successfully, but the container exits immediately. How would you troubleshoot it?](../topics/docker.md#your-docker-image-builds-successfully-but-the-container-exits-immediately-how-wo) — 1×
  <a id="your-docker-image-builds-successfully-but-the-container-exits-immediately-how-wo"></a>
...
- [Docker architectures](../topics/docker.md#docker-architectures) — 2×
  <a id="docker-architectures"></a>
- [What are best practices for Docker in production?](../topics/docker.md#what-are-best-practices-for-docker-in-production) — 2×
  <a id="what-are-best-practices-for-docker-in-production"></a>
- [Design, automate, and manage scalable cloud infrastructure using Microsoft Azure, Terraform, Azure DevOps, and Docker.](../topics/docker.md#design-automate-and-manage-scalable-cloud-infrastructure-using-microsoft-azure-t) — 1× · tags: `Terraform`, `Azure DevOps`, `Azure`, `System Design`
  <a id="design-automate-and-manage-scalable-cloud-infrastructure-using-microsoft-azure-t"></a>
- [Explain the Docker architecture.](../topics/docker.md#explain-the-docker-architecture) — 1× · tags: `System Design`
...
- [If Docker images are built in Jenkins but security scanning must happen in GitHub Actions, how would you design the workflow?](../topics/docker.md#if-docker-images-are-built-in-jenkins-but-security-scanning-must-happen-in-githu) — 1× · tags: `Jenkins`, `GitHub Actions`
...
- [What are common Docker production issues and fixes?](../topics/docker.md#what-are-common-docker-production-issues-and-fixes) — 1×
  <a id="what-are-common-docker-production-issues-and-fixes"></a>
...
- [If Docker images are built in Jenkins but security scanning must happen in GitHub Actions, how would you design the workflow?](../topics/docker.md#if-docker-images-are-built-in-jenkins-but-security-scanning-must-happen-in-githu) — tags: `Jenkins`, `GitHub Actions`
...
- [Can you explain how Docker works?](../topics/docker.md#can-you-explain-how-docker-works)
...
- [Can you explain your experience with Docker?](../topics/docker.md#can-you-explain-your-experience-with-docker)
- [Can you write a command to add volume or bind mount in container](../topics/docker.md#can-you-write-a-command-to-add-volume-or-bind-mount-in-container)
- [Can you write a multi-stage Dockerfile?](../topics/docker.md#can-you-write-a-multi-stage-dockerfile)
- [Can you write a simple docker file](../topics/docker.md#can-you-write-a-simple-docker-file)
- [Container restarted and data got lost — how do you fix it?](../topics/docker.md#container-restarted-and-data-got-lost-how-do-you-fix-it)
- [Design, automate, and manage scalable cloud infrastructure using Microsoft Azure, Terraform, Azure DevOps, and Docker.](../topics/docker.md#design-automate-and-manage-scalable-cloud-infrastructure-using-microsoft-azure-t) — tags: `Terraform`, `Azure DevOps`, `Azure`, `System Design`
- [Docker](../topics/docker.md#docker)
- [Docker and Containers](../topics/docker.md#docker-and-containers)
...
- [Explain how Docker fits into your CI/CD pipeline project.](../topics/docker.md#explain-how-docker-fits-into-your-ci-cd-pipeline-project) — tags: `CI/CD`
- [Explain the Docker architecture.](../topics/docker.md#explain-the-docker-architecture) — tags: `System Design`
...
- [How do you deploy applications using Docker?](../topics/docker.md#how-do-you-deploy-applications-using-docker)
- [How do you deploy multiple microservices using Docker Compose?](../topics/docker.md#how-do-you-deploy-multiple-microservices-using-docker-compose)
...
- [How do you manage environment-specific configuration in Docker?](../topics/docker.md#how-do-you-manage-environment-specific-configuration-in-docker)
...
- [How do you secure container images before deployment?](../topics/docker.md#how-do-you-secure-container-images-before-deployment)
...
- [How do you use docker stats during troubleshooting?](../topics/docker.md#how-do-you-use-docker-stats-during-troubleshooting)
...
- [How would you use Docker to implement a Pub/Sub system?](../topics/docker.md#how-would-you-use-docker-to-implement-a-pub-sub-system)
...
- [What are Docker registries and how do they work?](../topics/docker.md#what-are-docker-registries-and-how-do-they-work)
- [What are Docker volumes and bind mounts?](../topics/docker.md#what-are-docker-volumes-and-bind-mounts)
- [What are Docker volumes used for?](../topics/docker.md#what-are-docker-volumes-used-for)
- [What are Docker Volumes, and why are they used?](../topics/docker.md#what-are-docker-volumes-and-why-are-they-used)
- [What are Dockerfile best practices?](../topics/docker.md#what-are-dockerfile-best-practices)
- [What are Multi-Stage Docker Builds and why are they important?](../topics/docker.md#what-are-multi-stage-docker-builds-and-why-are-they-important)
- [What are multi-stage Docker builds?](../topics/docker.md#what-are-multi-stage-docker-builds)
- [What are the 3 types of Docker volumes?](../topics/docker.md#what-are-the-3-types-of-docker-volumes)
...
- [What is a Docker container?](../topics/docker.md#what-is-a-docker-container)
- [What is a Docker image?](../topics/docker.md#what-is-a-docker-image)
- [What is a Dockerfile and how do you create one?](../topics/docker.md#what-is-a-dockerfile-and-how-do-you-create-one)
- [What is a multi-stage Docker build?](../topics/docker.md#what-is-a-multi-stage-docker-build)
- [What is containerization, and how do you deploy a .NET application using Docker?](../topics/docker.md#what-is-containerization-and-how-do-you-deploy-a-net-application-using-docker)
- [What is Docker and how does it work?](../topics/docker.md#what-is-docker-and-how-does-it-work)
...
- [What is Docker?](../topics/docker.md#what-is-docker)
- [What is the command to run a container](../topics/docker.md#what-is-the-command-to-run-a-container)
...
- [What is the Docker daemon?](../topics/docker.md#what-is-the-docker-daemon)
- [What is the purpose of a Docker image?](../topics/docker.md#what-is-the-purpose-of-a-docker-image)
- [What is the purpose of depends_on in Docker Compose?](../topics/docker.md#what-is-the-purpose-of-depends-on-in-docker-compose)
- [What is the purpose of FROM in a Dockerfile?](../topics/docker.md#what-is-the-purpose-of-from-in-a-dockerfile)
...
| [A Docker container works locally but fails in production. Why?](../topics/docker.md#a-docker-container-works-locally-but-fails-in-production-why) | Hard | 2 |
| [A Docker image has 10 layers, and all layers are already cached. If you modify Layer 5 and rebuild the image, what will happen? Will Docker reuse the cache for Layers 6–10, or will those layers be rebuilt? Explain why.](../topics/docker.md#a-docker-image-has-10-layers-and-all-layers-are-already-cached-if-you-modify-lay) | Medium | 2 |
| [Can you explain how Docker works?](../topics/docker.md#can-you-explain-how-docker-works) | Medium | 1 |
| [Can you explain the concept of Docker and how do you use it in your projects?](../topics/docker.md#can-you-explain-the-concept-of-docker-and-how-do-you-use-it-in-your-projects) | Medium | 1 |
| [Can you explain your experience with Docker?](../topics/docker.md#can-you-explain-your-experience-with-docker) | Medium | 1 |
| [Can you write a command to add volume or bind mount in container](../topics/docker.md#can-you-write-a-command-to-add-volume-or-bind-mount-in-container) | Medium | 1 |
| [Can you write a multi-stage Dockerfile?](../topics/docker.md#can-you-write-a-multi-stage-dockerfile) | Medium | 1 |
| [Can you write a simple docker file](../topics/docker.md#can-you-write-a-simple-docker-file) | Medium | 1 |
...
| [Design, automate, and manage scalable cloud infrastructure using Microsoft Azure, Terraform, Azure DevOps, and Docker.](../topics/docker.md#design-automate-and-manage-scalable-cloud-infrastructure-using-microsoft-azure-t) | Hard | 1 |
| [Docker](../topics/docker.md#docker) | Medium | 2 |
| [Docker and Containers](../topics/docker.md#docker-and-containers) | Medium | 2 |
| [Docker architectures](../topics/docker.md#docker-architectures) | Hard | 2 |
...
| [Explain the Docker architecture.](../topics/docker.md#explain-the-docker-architecture) | Hard | 1 |
...
| [How do you check Docker container logs?](../topics/docker.md#how-do-you-check-docker-container-logs) | Medium | 2 |
...
| [How do you deploy applications using Docker?](../topics/docker.md#how-do-you-deploy-applications-using-docker) | Medium | 1 |
| [How do you deploy multiple microservices using Docker Compose?](../topics/docker.md#how-do-you-deploy-multiple-microservices-using-docker-compose) | Medium | 1 |
| [How do you inject environment variables during Docker builds and where do you store images?](../topics/docker.md#how-do-you-inject-environment-variables-during-docker-builds-and-where-do-you-st) | Medium | 2 |
...
| [How do you manage environment-specific configuration in Docker?](../topics/docker.md#how-do-you-manage-environment-specific-configuration-in-docker) | Medium | 1 |
...
| [How do you secure container images before deployment?](../topics/docker.md#how-do-you-secure-container-images-before-deployment) | Medium | 2 |
| [How do you secure Docker containers?](../topics/docker.md#how-do-you-secure-docker-containers) | Medium | 1 |
| [How do you secure Docker images before deploying them to production?](../topics/docker.md#how-do-you-secure-docker-images-before-deploying-them-to-production) | Hard | 1 |
| [How do you troubleshoot high CPU usage in a Docker container?](../topics/docker.md#how-do-you-troubleshoot-high-cpu-usage-in-a-docker-container) | Medium | 1 |
...
| [How does Docker's containerization work?](../topics/docker.md#how-does-docker-s-containerization-work) | Medium | 1 |
...
| [How would you use Docker to implement a Pub/Sub system?](../topics/docker.md#how-would-you-use-docker-to-implement-a-pub-sub-system) | Medium | 1 |
| [If Docker images are built in Jenkins but security scanning must happen in GitHub Actions, how would you design the workflow?](../topics/docker.md#if-docker-images-are-built-in-jenkins-but-security-scanning-must-happen-in-githu) | Hard | 1 |
...
| [What are Docker volumes used for?](../topics/docker.md#what-are-docker-volumes-used-for) | Easy | 2 |
| [What are Docker Volumes, and why are they used?](../topics/docker.md#what-are-docker-volumes-and-why-are-they-used) | Easy | 1 |
| [What are Dockerfile best practices?](../topics/docker.md#what-are-dockerfile-best-practices) | Easy | 1 |
| [What are Multi-Stage Docker Builds and why are they important?](../topics/docker.md#what-are-multi-stage-docker-builds-and-why-are-they-important) | Easy | 1 |
| [What are multi-stage Docker builds?](../topics/docker.md#what-are-multi-stage-docker-builds) | Easy | 1 |
| [What are the 3 types of Docker volumes?](../topics/docker.md#what-are-the-3-types-of-docker-volumes) | Easy | 2 |
| [What best practices do you follow while writing a production-ready Dockerfile?](../topics/docker.md#what-best-practices-do-you-follow-while-writing-a-production-ready-dockerfile) | Hard | 1 |
...
| [What happens internally when you run docker run?](../topics/docker.md#what-happens-internally-when-you-run-docker-run) | Medium | 6 |
...
| [What is containerization, and how do you deploy a .NET application using Docker?](../topics/docker.md#what-is-containerization-and-how-do-you-deploy-a-net-application-using-docker) | Medium | 1 |
...
| [What is Docker Networking?](../topics/docker.md#what-is-docker-networking) | Easy | 1 |
| [What is Docker?](../topics/docker.md#what-is-docker) | Easy | 3 |
...
| [What is the difference between a Docker Image and a Docker Container?](../topics/docker.md#what-is-the-difference-between-a-docker-image-and-a-docker-container) | Easy | 5 |
...
| [What is the purpose of depends_on in Docker Compose?](../topics/docker.md#what-is-the-purpose-of-depends-on-in-docker-compose) | Easy | 2 |
| [What is the purpose of FROM in a Dockerfile?](../topics/docker.md#what-is-the-purpose-of-from-in-a-dockerfile) | Easy | 1 |
| [What problem does Docker solve?](../topics/docker.md#what-problem-does-docker-solve) | Medium | 1 |
...
| [Write a simple Dockerfile and explain each instruction.](../topics/docker.md#write-a-simple-dockerfile-and-explain-each-instruction) | Medium | 2 |
...
| [Your container is running, but the application is not accessible. How would you troubleshoot it?](../topics/docker.md#your-container-is-running-but-the-application-is-not-accessible-how-would-you-tr) | Medium | 3 |
